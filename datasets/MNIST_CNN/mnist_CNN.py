...
class MNIST_CNN(object):
    """ MNIST CNN Benchmark dataset for bayesian optimization
    """
    ...
    def sample_initial_dataset(self) -> None:
        self.X_full_origin = np.load("./datasets/MNIST_CNN/optim_dataset/hyperparams.npy")
        self.y_full_origin = -np.load("./datasets/MNIST_CNN/optim_dataset/accuracies.npy")
