...
class FashionMNIST_CNN(object):
    ...
    def sample_initial_dataset(self) -> None:
        self.X_full_origin = np.load("./datasets/FashionMNIST_CNN/optim_dataset/hyperparams.npy")
        self.y_full_origin = -np.load("./datasets/FashionMNIST_CNN/optim_dataset/accuracies.npy")
